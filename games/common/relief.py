...
NATIVE = {
    ...
    "hearth-zero": {3: "flame"},
    "night-swarm": {1: "foe", 0: "floor", 2: "ship", 5: "swarm"},
    ...
    "memory-mosaic": {0: "card", 1: "card", 4: "card-back", 6: "card-back", 7: "card"},
    "twenty-one": {7: "card"},
    "orbit-dodge": {2: "ship", 3: "gem", 5: "orb", 7: "socket"},
    "gate-runner": {1: "wall-metal", 2: "ship", 6: "pit"},
    "brick-pulse": {},
    "star-lance": {1: "foe", 2: "ship", 5: "foe"},
    "ribbon-snake": {0: "floor", 2: "snake", 3: "gem", 4: "ribbon"},
    "lunar-touchdown": {2: "lander"},
    "echo-parry": {2: "knight", 5: "shield", 6: "knight"},
    "pendulum-port": {2: "person", 3: "socket", 6: "switch"},
    "ruin-lexicon": {},
    "shadow-archive": {0: "person", 1: "person", 2: "person"},
    "compass-rose": {1: "stone", 0: "floor-soil", 2: "person", 4: "floor-grid"},
