...
[Wiki](https://github.com/zabaglione/jr100dev/wiki/RIBBON-SNAKE) · [プレイ](https://zabaglione.github.io/pyjr100emu/?game=ribbon-snake)
...
[![操作を進めた場面・クリックで動画](images/demo-play.png)](https://zabaglione.github.io/pyjr100emu/gameplay.html?game=ribbon-snake)
...
頭と胴を丸みのある形にし、光沢と下側の影を付けました。盤面の厚みを加えつつ、通れるマスは正方格子で示します。 向きに応じて1体4文字のPCGを書き換えます。
...
蛇の頭が進行方向を向きます。伸びた胴体と区別しながら、次に進む方向を確認できます。演出中の追加入力は受け付けません。
...
バージョン 1.5.0。開始番地 `$0300`、ゲーム本体と定数は 6,493 bytes。画面・作業領域・復帰用の保存領域・512 bytesのスタックを含めて標準RAM 16KB内で動作します。PCGは32文字を場面ごとに切り替えます。
