...
壁を石積みの立体ブロック、出口をくぼんだ台座にしました。計画経路・標的の選択枠・斬撃は従来の位置で判別できます。 剣士が計画した経路を中間位置を通って進み、標的を一体ずつ、光・破片・粒に変えて斬ります。
...
剣士が計画した経路を中間位置を通って進み、標的を一体ずつ、光・破片・粒に変えて斬ります。被弾や結果を確認する間は、追加入力で表示を飛ばせません。
