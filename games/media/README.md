...
新規の Python devkit プロジェクトは [`games/dev.py release`](../../docs/python-games/README.md) を使います。作品内の `tests/replay.json` から撮影し、PRG・ソース・画像・動画をまとめます。以下は既存 51 作品の制作・公開手順です。
