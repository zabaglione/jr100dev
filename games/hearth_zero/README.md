...
左の大きな暖炉と右の雪を対置します。石の刻印を思わせるロゴで、熱源を守る世界を表します。
...
バージョン 1.3.0。開始番地 `$0300`、ゲーム本体と定数は 6,470 bytes。画面・作業領域・復帰用の保存領域・512 bytesのスタックを含めて標準RAM 16KB内で動作します。PCGは32文字を場面ごとに切り替えます。
