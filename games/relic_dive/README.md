...
大きな石碑風ロゴ、奥行きのある迷宮と遺物、明滅する光を描いたタイトル画面です。文字列を圧縮し、ゲーム内容を維持したまま標準16KB内に収めています。
...
バージョン：1.2.0。ゲーム本体と定数は11,371 bytes、PCGはタイトルで32文字、ゲーム中は31文字を切り替えて使います。RAM画面・作業領域・復帰用保存領域・512 bytesのスタックを含め、標準RAM 16KB内に収めています。現在の版に効果音・BGMはありません。
