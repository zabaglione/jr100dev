...
バージョン：1.4.0。ゲーム本体と定数は11,499 bytes、PCGはタイトルで32文字、ゲーム中は31文字を切り替えて使います。RAM画面・作業領域・復帰用保存領域・512 bytesのスタックを含め、標準RAM 16KB内に収めています。クリア時に短いジングルを流します。通常プレイ中の効果音・BGMはありません。
