...
攻撃では主人公が踏み込んで光弾を飛ばし、命中した敵が点滅します。防御では盾が広がり、敵の攻撃から防いだ量と残るダメージを表示します。被弾すると主人公が点滅して後ずさりし、回復では光が上昇します。HPや防御値の変化を確認する間を挟み、敵の消滅と勝利報酬まで順番に表示します。被弾や結果を確認する間は、追加入力で表示を飛ばせません。
