...
鏡を回すと、光がつながった線として伸びていきます。鏡の面で線が折れ曲がり、反射音とともに受光器までの経路を追えます。演出中の追加入力は受け付けません。
...
バージョン 1.6.0。開始番地 `$0300`、ゲーム本体と定数は 6,837 bytes。画面・作業領域・復帰用の保存領域・512 bytesのスタックを含めて標準RAM 16KB内で動作します。PCGは32文字を場面ごとに切り替えます。
