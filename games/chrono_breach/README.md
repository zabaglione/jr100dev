...
金属壁に上面と暗い側面を付け、出口を奥行きのある門にしました。弾道予測と敵の向きは手前に残し、射線の読みやすさを優先しています。 移動の中間位置と発射後の線を表示し、倒した敵は発光・破片・細かな粒の順に消えます。
...
移動の中間位置と発射後の線を表示し、倒した敵は発光・破片・細かな粒の順に消えます。被弾や結果を確認する間は、追加入力で表示を飛ばせません。
