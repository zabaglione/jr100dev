...
[Wikiのジャンル別一覧](https://github.com/zabaglione/jr100dev/wiki) · [共通操作](https://github.com/zabaglione/jr100dev/wiki/Controls) · [画面表現の工夫](https://github.com/zabaglione/jr100dev/wiki/Visual-Design) · [専用フォント](https://github.com/zabaglione/jr100dev/wiki/Font-Design)
...
| [ORBIT DRAFT](orbit_draft/) | 九つの軌道に札を配り三連の共鳴を作る |
...
`common/`は入力、PCG・文字描画、画面復帰、単音の効果音・BGMを提供します。VIA Timer 1を音、Timer 2を更新に使います。通常の描画中は次の1操作を保持します。連続移動の演出中とクリアジングル中は追加入力を捨て、意図しない次の操作を防ぎます。BGMと効果音の同時発音はせず、重要な効果音を優先します。
