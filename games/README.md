...
| [MAGNET VAULT](magnet_vault/) | 押せない金属塊を磁力で引いて収納する |
| [FROST STEPS](frost_steps/) | 氷上を止まれず滑り、全結晶を拾う |
| [PRISM TRACE](prism_trace/) | 鏡の向きを変えて光を受光器へ導く |
| [TIDE BRIDGE](tide_bridge/) | 潮位の連動する橋を切り替えて渡る |
| [GLYPH SHIFT](glyph_shift/) | 物体の通行ルールを書き換えて脱出する |
| [GRAVITY WELL](gravity_well/) | 盤面を傾けて複数の球を同時に収める |
