...
ロゴを取り囲む敵の群れと下部の小さな自機で圧迫感を出し、文字に細いスリットを入れています。
...
バージョン 1.3.0。開始番地 `$0300`、ゲーム本体と定数は 7,694 bytes。画面・作業領域・復帰用の保存領域・512 bytesのスタックを含めて標準RAM 16KB内で動作します。PCGは32文字を場面ごとに切り替えます。
