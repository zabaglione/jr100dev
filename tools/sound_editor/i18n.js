...
export const TRANSLATIONS = Object.freeze({
  ja: {
    ...
    "provenance.summary": "初期プロジェクトにはBGM 12曲とオリジナル効果音11種類があります。以下は代表例です。全件の来歴はリポジトリのdocs/sound_samples.mdに記載しています。",
    "provenance.asset": "資産",
  ...
  en: {
    ...
    "provenance.summary": "The starter project includes 12 BGM samples and 11 original SFX samples. The rows below are representative; full provenance is documented in docs/sound_samples.md.",
