...
2026年9月18日、SuperStation One実機と`JR100_20260801.rbf`で確認しました。標準RAM 16KBの設定で、以下の4作品が配布PRGから自動起動し、本編に進むことを確認しています。

| 作品 | SS1で確認した内容 |
| --- | --- |
| FROST STEPS | 開始・移動・クリスタル取得 |
| GATE RUNNER | 開始・障害物の進行・穴に落ちた際の失敗表示 |
| STAR LANCE | 開始・移動・通常弾と重い弾の発射 |
| NIGHT SWARM | 開始・移動・パルス攻撃 |

STAR LANCEは、実機所有者による物理パッド操作と効果音の確認も済んでいます。他の3作品の音声・物理パッド操作、全ステージ、残り47作品のSS1動作は未確認です。オリジナルのJR-100実機でも未確認です。
