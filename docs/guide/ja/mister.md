...
STAR LANCE 3.0.0は、実機所有者による物理パッド操作と効果音の確認も済んでいます。改修後の4.0.0はエミュレーターで検証しており、SS1での再確認は未実施です。他の3作品の音声・物理パッド操作、全ステージ、残り47作品のSS1動作は未確認です。オリジナルのJR-100実機でも未確認です。
