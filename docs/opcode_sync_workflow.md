...
## 概要
`tools/sync_opcodes.py` は `pyjr100emu` の CPU 実装から MB8861H 命令セットを抽出し、`src/jr100dev/asm/opcodes_mb8861h.py` と JSON マニフェストを自動生成する。
