...
左半分の大きな十字と右の光の結晶を対置します。ロゴには結晶の切り口を加えています。
...
バージョン 1.4.0。開始番地 `$0300`、ゲーム本体と定数は 6,670 bytes。画面・作業領域・復帰用の保存領域・512 bytesのスタックを含めて標準RAM 16KB内で動作します。PCGは32文字を場面ごとに切り替えます。
