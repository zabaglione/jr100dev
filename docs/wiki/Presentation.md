...
全作品の紹介ページに、開始・進行・目標達成の3枚以上の画像と、約30秒の音付き動画を掲載しています。基本は最初のステージのクリアまでです。長いゲームは途中を省略し、LATERを表示します。入力の間に盤面を見る時間を設けた自動リプレイで、ゲーム画面と音声の速度は変えていません。動画を見るだけならROMは不要です。
